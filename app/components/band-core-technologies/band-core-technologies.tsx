    ...
    <section className="band is-fold nsc-band-core-technologies">
      <div className="band-content">
        <ul className="spec-list">
          ...
          <li className="spec-row">
            <h2 className="spec-name">C# .NET, MVC</h2>
            <p className="spec-note">jquery, ajax spa libraries, kendoUI, signalR</p>
          </li>
          ...
          <li className="spec-row">
            ...
            <p className="spec-note">claude code, github copilot, chatGPT - balance strengths/limitations</p>
          </li>
          ...
          <li className="spec-row">
            <h2 className="spec-name">Github, Figma</h2>
            <p className="spec-note">and other workflow tools: VScode, vercel, photoshop</p>
          </li>
